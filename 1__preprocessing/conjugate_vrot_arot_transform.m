  function [conjugate_profile] = conjugate_vrot_arot_transform(profile )
  ...
  % Modified by Kianoosh Ghazi to account for acceleration 10/06/2020
  % Initialization
  t_vrot_rotated = profile(:,1:3);
